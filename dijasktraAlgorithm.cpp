...
void grafo_criar(void){
 ...
 do {
 printf("Informe o vertice de Origem (entre 1 e %d ou 0 para sair): ", vertices);
 scanf("%d", &origem);
 } while (origem < 0 || origem > vertices);
 if (origem) {
 do {
 printf("Informe o vertice de Destino (entre 1 e %d, menos %d): ", vertices,
origem);
 scanf("%d", &destino);
 } while (destino < 1 || destino > vertices || destino ==
origem);
 do {
 printf("Informe o custo correspondente ao vertice: ",
 origem, destino);
 scanf("%d",&custo);
 } while (custo < 0);
...
void menu_mostrar(void){
 ...
 printf("\n");
 printf("\n");
 printf("======///====== Mike de Santana Santos - Eng Software RA: *********** ======///====== \n");
 printf("\n");
 printf("\n");
